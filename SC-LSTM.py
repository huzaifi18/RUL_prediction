...
def main():
    ...
    for j, (train_idx, val_idx) in enumerate(folds):
        ...
        trainX, trainY, SS_tr = extract_VIT_capacity(train_x_data, train_y_data, 5, 1, 10)
        valX, valY, SS_val = extract_VIT_capacity(val_x_data, val_y_data, 5, 1, 10)
